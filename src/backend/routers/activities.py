...
def get_activities(
    ...
    - difficulty_level: Filter activities by difficulty level (e.g., 'Beginner', 'Intermediate', 'Advanced', 'none' for no level)
    """
    ...
    if difficulty_level:
        if difficulty_level == "none":
            # Query for activities that don't have difficulty_level field
